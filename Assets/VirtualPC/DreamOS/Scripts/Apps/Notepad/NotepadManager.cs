...
namespace com.lockedroom.io.module.pc
{
    public class NotepadManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            libraryAsset = ScriptableObject.CreateInstance<NotepadLibrary>();
        ...
        void OnDestroy()
        {
            for (int i = libraryAsset.notes.Count - 1; i >= 0; i--)
            {
                if (libraryAsset.notes[i].isCustom || libraryAsset.notes[i].isDeleted) {
