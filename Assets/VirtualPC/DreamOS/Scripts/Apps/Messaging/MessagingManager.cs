...
namespace com.lockedroom.io.module.pc
{
    public class MessagingManager : MonoBehaviour
    {
        ...
        public void InsGallery(Transform parent, int layoutIndex, Sprite sprite, string title, string description, string time) {
            ...
            if (time == "") { GetTimeData(); timeText.text = timeHelper; } else { timeText.text = time; }
        ...
        public void InsAu(Transform parent, int layoutIndex, AudioClip audio, string time) {
            if (parent == null) { parent = chatViewer.Find(chatList[layoutIndex].chatTitle).GetComponent<Transform>(); }
