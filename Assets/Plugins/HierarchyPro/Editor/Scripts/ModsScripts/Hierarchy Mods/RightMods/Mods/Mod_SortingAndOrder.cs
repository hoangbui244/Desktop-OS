...
namespace EMX.HierarchyPlugin.Editor.Mods
{
    ...
    class Mod_SpritesOrder : RightModBaseClass
    {
        ...
        void DrawSortingOrder( Rect drawRect, Renderer r, HierarchyObject _o )
        {
            ...
            {
                ra = adapter.modsController.rightModsManager.DrawCursorRect( ref drawRect, style, "" );
        ...
        void DrawLayers( Rect drawRect, Renderer r, HierarchyObject _o )
        {
            ...
            if ( r )
            {
                ...
                else //GUI.Label(drawRect, "-");
                {
                    ...
                    Draw_Label( drawRect, RightModsManager.GetEmptyConten, style, true );
                    ra = adapter.modsController.rightModsManager.DrawCursorRect( ref drawRect, style, RightModsManager.GetEmptyConten );
                }
            }
            else
            {
