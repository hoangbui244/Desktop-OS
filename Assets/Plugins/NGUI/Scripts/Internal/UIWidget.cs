...
public class UIWidget : UIRect
{
	...
	protected override void OnAnchor ()
	{
            ...
            rightAnchor.target)
        {
            ...
            {
                int leftOfferValue = 50;
                int rightOfferValue = 50;
                //if (pvt.x == 0)
                //{
                //    leftOfferValue *= 2;
                //    rightOfferValue *= 2;
                ...
                {
                    newPos = new Vector3(Mathf.Lerp(lt + leftOfferValue, rt, pvt.x), Mathf.Lerp(bt, tt, pvt.y), pos.z);
                }
                else if (leftAnchor.relative == 1)
                {
                    newPos = new Vector3(Mathf.Lerp(lt, rt - rightOfferValue, pvt.x), Mathf.Lerp(bt, tt, pvt.y), pos.z);
                }
            }
        }
#endif
