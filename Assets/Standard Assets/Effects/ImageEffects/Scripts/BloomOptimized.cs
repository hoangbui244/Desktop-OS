...
namespace UnityStandardAssets.ImageEffects {
    ...
    public class BloomOptimized : PostEffectsBase {
        ...
        public Texture bloomAddTexture;
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination) {
            ...
            //bloomAddTexture = null;
            //if (XPPostTextureCreate.Instance != null) {
            //    bloomAddTexture = XPPostTextureCreate.Instance.m_bloomAddTexture;
            //}
            //if (bloomAddTexture != null) {
            //    fastBloomMaterial.SetTexture("_BloomAdditive", bloomAddTexture);
            //    Graphics.Blit(source, rt, fastBloomMaterial, 7);
            //} else {
            ...
            //{
            //    refractTexture.wrapMode = TextureWrapMode.Repeat;
            //    refractTexture.filterMode = FilterMode.Bilinear;
            //    fastBloomMaterial.SetTexture("_BloomRefract", refractTexture);
            //    Graphics.Blit(source, destination, fastBloomMaterial, 6);
            //}
            //else
            //{
            //*/
