...
namespace EMX.HierarchyPlugin.Editor
{
	...
	partial class Tools
	{
		...
		static Dictionary<Type, ConcurrentDictionary<string, FieldAdapter>> _SCAN_FIELDS_CACHE = new Dictionary<Type, ConcurrentDictionary<string, FieldAdapter>>();
		static Dictionary<Type, ConcurrentDictionary<string, FieldAdapter>> _SCAN_FIELDS_CACHE_NOARRAYS = new Dictionary<Type, ConcurrentDictionary<string, FieldAdapter>>();
