...
public class ShakeDemo : MonoBehaviour 
{
	...
	void OnGUI()
    {
        ...
        if (GUILayout.Button("Earthquake"))
        {
            CameraShaker.Instance.Shake(CameraShakePresets.Earthquake);
        }
        if (GUILayout.Button("BadTrip"))
        {
            CameraShaker.Instance.Shake(CameraShakePresets.BadTrip);
        }
        if (GUILayout.Button("HandheldCamera"))
        {
        ...
        if (GUILayout.Button("RoughDriving"))
        {
