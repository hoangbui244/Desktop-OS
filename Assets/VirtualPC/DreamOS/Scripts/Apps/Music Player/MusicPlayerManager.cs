...
namespace com.lockedroom.io.module.pc {
    public class MusicPlayerManager : MonoBehaviour {
        ...
        private List<EventInstance> musicEventInstance;
        ...
        private void Start() {
            ...
            result = system.createChannelGroup("DesktopOS", out channelGroup);
            channel.setChannelGroup(channelGroup);
        }
        private static int SortByName(AudioData o1, AudioData o2) {
        ...
        void PrepareMusicPlayer() {
            ...
            if (sortListByName == true) { userManager.audioAlbum.Sort(SortByName); }

            // Instantiate the entire playlist songs as buttons
            for (int i = 0; i < userManager.audioAlbum.Count; ++i) {
                ...
                go.gameObject.name = userManager.audioAlbum[i].musicTitle;
                ...
                string imgPath = userManager.audioAlbum[i].imgPath;
                string musicPath = Application.dataPath + "/" + userManager.audioAlbum[i].musicPath;
                ...
                songName.text = userManager.audioAlbum[i].musicTitle;
                TextMeshProUGUI artistName = go.transform.Find("Artist Name").GetComponent<TextMeshProUGUI>();
                artistName.text = userManager.audioAlbum[i].artistTitle;
                ...
                itemButton.onClick.AddListener(delegate {
                    result = system.createSound(musicPath, FMOD.MODE.DEFAULT, out sound1);
        ...
        public void GetMusicInfo() {
            TextMeshProUGUI musicTitle = miniPlayer.Find("Music Title").GetComponent<TextMeshProUGUI>();
            musicTitle.text = "abc";
            TextMeshProUGUI artistMiniName = miniPlayer.transform.Find("Artist Name").GetComponent<TextMeshProUGUI>();
            artistMiniName.text = "abc";
        }
        ...
        public void ShowPlayTime() {
            seconds = (int)playTime % 60; secondsRaw = playTime % 60; minutes = ((int)playTime / 60) % 60;
        }
