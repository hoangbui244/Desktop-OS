...
#pragma warning restore
        ...
        internal static void DrawCustomModules2( PluginInstance adapter, Rect R, Rect R2 )
        {
            ...
            r.y += r.height;
            if ( GUI.Button( r, "Open " + Settings.RightHierarchyModsSettingsEditor.set_text.Substring( 4 ) + " Settings" ) ) { Settings.MainSettingsEnabler_Window.Select<Settings.RM_Window>(); }
