...
#pragma warning restore
        ...
        internal override void ModuleCommonGenericMenu( GenericMenu menu, GameObject activeGo, object _c, string sub = "" )
        {
            ...
            menu.AddItem( new GUIContent( sub + "Use Broadcast To Children" ), adapter.par_e.RIGHT_MOD_BROADCAST_ENABLED, () => {
                Clear();
...
#pragma warning restore
        ...
        public override void Draw() //Profiler.GetRuntimeMemorySizeLong( !!!!!!!!!!!!!!!
        {
            ...
            Draw_ModuleButton( drawRect, content, BUTTON_ACTION_HASH, hasContent, dsc, drawPointer: true );
