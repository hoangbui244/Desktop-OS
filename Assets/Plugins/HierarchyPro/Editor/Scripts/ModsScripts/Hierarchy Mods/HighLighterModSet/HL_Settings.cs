...
namespace EMX.HierarchyPlugin.Editor
{
    ...
    partial class EditorSettingsAdapter
    {
        ...
        internal partial class HighlighterSettings
        {
			...
			internal int HIGHLIGHTER_CUSTOM_ICON_LOCATION { get { return s.GET( KEY + "_CUSTOM_ICON_LOCATION", 0 ); } set { var r = HIGHLIGHTER_CUSTOM_ICON_LOCATION; s.SET( KEY + "_CUSTOM_ICON_LOCATION", value ); p.RESET_DRAWSTACK( pluginID ); } }
            ...
            internal int HIGHLIGHTER_TEXTURE_STYLE { get { return s.GET( KEY + "_TEXTURE_STYLE", 0 ); } set { var r = HIGHLIGHTER_TEXTURE_STYLE; s.SET( KEY + "_TEXTURE_STYLE", value ); p.RESET_DRAWSTACK( pluginID ); } }
            internal int HIGHLIGHTER_TEXTURE_BORDER {
                get {
                    if ( HIGHLIGHTER_TEXTURE_STYLE == 0 ) return 0;
                    return s.GET( KEY + "_TEXTURE_BORDER", 6 );
                }
                set {
