...
namespace EMX.HierarchyPlugin.Editor
{
    ...
    partial class EditorSettingsAdapter
    {
        ...
        internal partial class WindowSettings
        {
            ...
            internal int LINE_HEIGHT { get { return Mathf.Clamp( s.GET( KEY + "_LINE_HEIGHT", 16 ), 10, 80 ); } set { var r = LINE_HEIGHT; if ( s.SET( KEY + "_LINE_HEIGHT", value ) ) p.RepaintWindowInUpdate_PlusResetStack( pluginID ); } }
            ...
            internal int OVERRIDE_DEFAULT_ICONS_SIZE { get { return s.GET( KEY + "_OVERRIDE_DEFAULT_ICONS_SIZE", (int)16 ); } set { var r = OVERRIDE_DEFAULT_ICONS_SIZE; if ( s.SET( KEY + "_OVERRIDE_DEFAULT_ICONS_SIZE", value ) ) p.RepaintWindowInUpdate_PlusResetStack( pluginID ); } }
           ...
           // }
            ...
            internal int DRAW_HIERARHCHY_CHESS_LINES { get { return s.GET( KEY + "_DRAW_HIERARHCHY_CHESS_LINES", 0 ); } set { var r = DRAW_HIERARHCHY_CHESS_LINES; if ( s.SET( KEY + "_DRAW_HIERARHCHY_CHESS_LINES", value ) ) p.RepaintWindowInUpdate( pluginID ); } }
...
0
            ...
            internal Color COLOR_HIERARHCHY_CHESS_FILLS {
                get { return s.GET( KEY + "_COLOR_HIERARHCHY_CHESS_FILLS", EditorGUIUtility.isProSkin ? new Color( 20 / 255f, 20 / 255f, 20 / 255f, 0.1F ) : new Color( 1f, 1f, 1f, 0.1F / 3 ) ); }
            ...
            internal Color COLOR_HIERARHCHY_CHILD_LINES {
                get { return s.GET( KEY + "_COLOR_HIERARHCHY_CHILD_LINES", EditorGUIUtility.isProSkin ? new Color( 0.8f, 0.8f, 0.8f, 0.35f ) : new Color( .5f, .5f, .5f, 100 / 255F ) ); }
            ...
            internal int DRAW_CHILDS_COUNT {
                ...
                get { return s.GET( KEY + "_DRAW_CHILDS_COUNT", 0 ); }
                set { var r = DRAW_CHILDS_COUNT; if ( s.SET( KEY + "_DRAW_CHILDS_COUNT", value ) ) p.RepaintWindowInUpdate( pluginID ); }
            }
            internal bool DRAW_CHILDS_INVERCE_COLOR { get { return s.GET( KEY + "_DRAW_CHILDS_INVERCE_COLOR", false ); } set { var r = DRAW_CHILDS_INVERCE_COLOR; if ( s.SET( KEY + "_DRAW_CHILDS_INVERCE_COLOR", value ) ) p.RepaintWindowInUpdate( pluginID ); } }
...
EditorGUIUtility.isProSkin ? Color.white : new Color( 0.8f, 0.8f, 0.8f, 1f ) );
                }
            ...
            internal int CHILDCOUNT_ALIGMENT { get { return s.GET( KEY + "_CHILDCOUNT_ALIGMENT", 1 ); } set { var r = CHILDCOUNT_ALIGMENT; if ( s.SET( KEY + "_CHILDCOUNT_ALIGMENT", value ) ) p.RepaintWindowInUpdate( pluginID ); } }
            internal int CHILDCOUNT_OFFSET_X { get { return s.GET( KEY + "_CHILDCOUNT_OFFSET_X", pluginID == 0 ? 0 : 30 ); } set { var r = CHILDCOUNT_OFFSET_X; if ( s.SET( KEY + "_CHILDCOUNT_OFFSET_X", value ) ) p.RepaintWindowInUpdate( pluginID ); } }
