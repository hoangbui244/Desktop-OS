...
#if UNITY_EDITOR
                    result = Application.dataPath + "/../Download/";//Application.persistentDataPath;
#elif UNITY_IPHONE
                    result = Application.persistentDataPath+"/SelfUpdateFile/";//Application.persistentDataPath;
#elif UNITY_ANDROID
                    result = Application.persistentDataPath+"/SelfUpdateFile/";//Application.persistentDataPath;
#else
                    result = Application.dataPath + "/../Download/";//Application.persistentDataPath;
